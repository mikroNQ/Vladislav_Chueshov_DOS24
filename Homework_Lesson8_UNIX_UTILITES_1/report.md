...
## Выполнил, не хватило времени оформить. Все 4 выходных был без доступа к ПК (пскольку форвординг портов не поддерживается браузером, использовал Zerotire для обхединения машин в общую сеть. Очень просто и быстро)
